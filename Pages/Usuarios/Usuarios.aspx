<%@ Page Title="" Language="C#" MasterPageFile="~/MP.Master" AutoEventWireup="true" CodeBehind="Usuarios.aspx.cs" Inherits="CRUD.Pages.Usuarios.Usuarios" %>
    ...
    <form runat="server" class="h-100 d-flex align-items-center justify-content-center">
        <div>
            ...
            <div class="mb-3">
                ...
                <asp:TextBox runat="server" CssClass="form-control" required="true" ID="tbemail"></asp:TextBox>
            </div>
                        <div class="mb-3">
                <label class="form-label">Telefono</label>
                <asp:TextBox runat="server" CssClass="form-control" required="true" ID="tbtelefono"></asp:TextBox>
            </div>
